...
Example of models that you might create include:
...
what parts are needed by the system. These diagrams are:
...
The textbook outlines 4 other problems or reasons why MDA is not widely adopted:
