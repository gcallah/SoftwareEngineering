...
There are two ways that an architectural model is used:
...
a basis for discussion or used as a document to outline implementation and design:
...
Models of application architectures can be used in several ways:
